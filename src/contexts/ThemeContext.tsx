...
export type FontColorKey =
    | 'default'
    | 'white' | 'mint' | 'neon' | 'lavender' | 'lightOrange'
    | 'black' | 'navyBlue' | 'brown' | 'darkGreen' | 'purple';
export type ThemeColors = {
    ...
    fieldBg: string;
    fieldBorder: string;
    fieldDisabledBg: string;
    fieldDisabledBorder: string;
    borderStrong: string;
    borderMid: string;
    borderSub: string;
    textPrimary: string;
...
export const THEMES: Record<ThemeKey, ThemeColors> = {
    navy: {
        ...
        fieldBg: '#384757',
        fieldBorder: '#6D8196',
        fieldDisabledBg: '#252D36',
        fieldDisabledBorder: '#313B46',
        borderStrong: '#6D8196',
        borderMid: '#4E5D6D',
        borderSub: '#313B46',
        textPrimary: '#BFCDDC',
        ...
        accentRed: '#C47A7A',
        accentRedBg: '#8B3A3A',
        accentRedLight: '#3A1E1E',
        accentRedLightBorder: '#5A2E2E',
        accentGold: '#C4A27A',
        accentOrange: '#C47A3A',
        errorRed: '#FF6B6B',
        greenBg: '#1E3328',
        greenBorder: '#2E5A3E',
        overlay88: 'rgba(22, 28, 36, 0.88)',
        overlay92: 'rgba(22, 28, 36, 0.92)',
    },
    citrus: {
        bgDeep: '#F0E4C8',
        bgPanel: '#F5C878',
        ...
        fieldBg: '#FFE8C8',
        fieldBorder: '#C87820',
        fieldDisabledBg: '#FAD898',
        fieldDisabledBorder: '#E8C880',
        borderStrong: '#C87820',
        borderMid: '#D89838',
        borderSub: '#E8C870',
        textPrimary: '#3A2000',
        textSecondary: '#6A3C00',
        textMuted: '#A06020',
        textDisabled: '#C8A060',
        accentBlue: '#B86010',
        accentGreen: '#4A7A20',
        accentRed: '#B83010',
        accentRedBg: '#FDDDD0',
        accentRedLight: '#FEF0EA',
        accentRedLightBorder: '#F5B8A0',
        accentGold: '#C87800',
        accentOrange: '#E05010',
        errorRed: '#CC2200',
        greenBg: '#E8F5D8',
        greenBorder: '#7AAA40',
        overlay88: 'rgba(240, 228, 200, 0.88)',
        overlay92: 'rgba(240, 228, 200, 0.92)',
    },
    light: {
        bgDeep: '#F0F4F8',
        bgPanel: '#FFFFFF',
        ...
        fieldBg: '#E8EEF4',
        fieldBorder: '#7A9AB8',
        fieldDisabledBg: '#DDE4EC',
        fieldDisabledBorder: '#C0D0E0',
        borderStrong: '#7A9AB8',
        borderMid: '#9AB0C8',
        borderSub: '#C0D0E0',
        textPrimary: '#1E2832',
        textSecondary: '#2E4A6A',
        textMuted: '#4A6A8A',
        textDisabled: '#8AA0B8',
        accentBlue: '#3A6A9E',
        accentGreen: '#2A7A4A',
        accentRed: '#9E3A3A',
        accentRedBg: '#F0D0D0',
        accentRedLight: '#FAE8E8',
        accentRedLightBorder: '#E0B0B0',
        accentGold: '#8A6020',
        accentOrange: '#9A5020',
        errorRed: '#CC2222',
        greenBg: '#D8F0E0',
        greenBorder: '#6AB88A',
        overlay88: 'rgba(200, 215, 230, 0.88)',
        overlay92: 'rgba(200, 215, 230, 0.92)',
    },
    dark: {
        bgDeep: '#0A0A0A',
        bgPanel: '#141414',
        ...
        fieldBg: '#202020',
        fieldBorder: '#505050',
        fieldDisabledBg: '#181818',
        fieldDisabledBorder: '#242424',
        borderStrong: '#505050',
        borderMid: '#383838',
        borderSub: '#242424',
        textPrimary: '#E0E0E0',
        ...
        accentRed: '#C06060',
        accentRedBg: '#5A2020',
        accentRedLight: '#2A1010',
        accentRedLightBorder: '#4A1E1E',
        accentGold: '#C0983A',
        accentOrange: '#C07030',
        errorRed: '#FF5555',
        greenBg: '#102010',
        greenBorder: '#1E481E',
        overlay88: 'rgba(10, 10, 10, 0.88)',
        overlay92: 'rgba(10, 10, 10, 0.92)'
    }
};
...
export const FONT_COLOR_KEYS_BY_THEME: Record<ThemeKey, FontColorKey[]> = {
    navy: DARK_THEME_FONT_COLOR_KEYS,
    dark: DARK_THEME_FONT_COLOR_KEYS,
    light: LIGHT_THEME_FONT_COLOR_KEYS,
    citrus: LIGHT_THEME_FONT_COLOR_KEYS
};
...
export const ThemeProvider = ({ children }: { children: ReactNode }) => {
    ...
    const saveSettings = async (updated: ThemeSettings) => {
        setSettings(updated);
        try { await AsyncStorage.setItem(THEME_STORAGE_KEY, JSON.stringify(updated)); }
        catch {}
    };
